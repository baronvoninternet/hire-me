...
import { fetchCount, fetchChildren } from './childListAPI';
...
export const { increment, decrement, incrementByAmount, setCurrentChildren, checkInChild, checkOutChild } = childListSlice.actions;
